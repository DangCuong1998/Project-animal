	...
	@section('title','Toàn bộ liên hệ')
		...
		<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
			...
			<body>
				...
				<div class="aKw" style="">
					<div class="aKy" style="">
						<div class="aKx" style="">
							<a href=""><div id=":2r" class="aKz" style="float: left;display: inline-block;margin-right: 300px">Tình trạng</div></a>
						</div>
				...
				<tr class="zA zE" jsaction="" jscontroller="" jsmodel="nXDxbd" id=":3k" tabindex="-1" aria-labelledby=":3l" draggable="true">
					...
					@foreach($model as $m)
					<td id=":3q" tabindex="-1" class="xY a4W">
										...
										<div class="block-content">
											<ul>
												...
												<li class="level0 parent ">
													...
													<a href="">
													<a href="{{route('backend.contact-destroy',['id'=>$m->id])}}"><button id="demo" onclick="myFunction() class="btn btn-danger" style="float: left;">Xóa</button></a>
					...
					<!-- jQuery -->@endforeach
					<script src="//code.jquery.com/jquery.js"></script><script>
function myFunction() {
